    ...
    static func real(baseURL: URL,
        ...
        return .init(
            lineStatuses: {
                ...
                return urlSession.performRequest(url: url,
...
private extension URLSession {
    ...
    func performRequest<T: Decodable>(url: URL, mappedTo: T.Type) -> AnyPublisher<T, TransportAPIClient.APIFailure> {
