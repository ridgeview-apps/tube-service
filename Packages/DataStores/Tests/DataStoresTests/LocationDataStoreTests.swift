...
struct LocationDataStoreTests {
    ...
    private func makeModel(locationManager: StubLocationManager = StubLocationManager(),
                           geocoder: ReverseGeocoderType = StubReverseGeocoder()) -> (StubLocationManager, LocationDataStore) {
