...
public extension ModelStubs {
    ...
    static var nationalRailStations: [StopPoint] { Station.allNationalRailStopPoints() }
    ...
    static var twickenhamRailStation: StopPoint { nationalRailStations.first { $0.icsCode == "1001300" }! }
    static var oakleighParkRailStation: StopPoint { nationalRailStations.first { $0.icsCode == "1001218" }! }
}
