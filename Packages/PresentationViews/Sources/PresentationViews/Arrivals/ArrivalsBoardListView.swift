...
public struct ArrivalsBoardListView: View {
    ...
    public init(
        boardStates: [ArrivalsBoardState],
...
#Preview("Loaded state") {
    WrapperView(
        boardStates: ModelStubs.elizabethLineBothPlatforms.toPlatformBoardStates(forLineID: .elizabeth),
        loadingState: .loaded
    )
}
...
#Preview("Loading state") {
    WrapperView(
        boardStates: ModelStubs.northernLineBothPlatforms.toPlatformBoardStates(),
