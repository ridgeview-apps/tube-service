...
extension LineDiagramItem.Style {
    static func stopPointTick(
        _ lineStyle: LineStyle,
        position: TickPosition = .center
    ) -> Self {
        .init(
            elementType: .stopPointTick(position),
            lineStyle: lineStyle,
    ...
    static func stopPointCircle(_ trainLineID: TrainLineID, hasTrailingLine: Bool) -> Self {
        ...
        return .init(
            elementType: .stopPointCircle(textOverlay),
    ...
    static func stopPointImage(_ modeID: ModeID, hasTrailingLine: Bool) -> Self {
        return .init(
            elementType: .stopPointImage(modeID.image),
