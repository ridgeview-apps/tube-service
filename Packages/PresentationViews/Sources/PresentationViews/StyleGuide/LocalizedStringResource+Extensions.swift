...
public extension LocalizedStringResource {
    ...
    static var settingsSystemStatusDetailUnableToLoad: LocalizedStringResource {
        moduleResource("settings.system.status.detail.unable.to.load")
    }
    
    static var settingsSystemStatusTitle: LocalizedStringResource {
        moduleResource("settings.system.status.title")
    }
    ...
    static var systemStatusBannerMoreInfoButtonTitle: LocalizedStringResource {
        moduleResource("system.status.banner.more.info.button.title")
    }
