...
public enum PreviewOptionDeviceType: String, Identifiable {
    ...
    public struct PreviewSizeClass {
    ...
    public var sizeClass: PreviewSizeClass {
        switch self {
...
extension View {
    ...
    public func previewOption(deviceType: PreviewOptionDeviceType) -> some View {
    ...
    public func previewOption(colorScheme: ColorScheme) -> some View {
        self.environment(\.colorScheme, colorScheme)
    }
    
    public func previewOption(contentSize: ContentSizeCategory) -> some View {
